...
class DashboardCustomizer {
	...
	public function login_assets() {
		wp_enqueue_style( 'login-stylesheet', get_template_directory_uri() . '/public/css/wp-dashboard/login.css', [], '1.0.0', 'all' );
	...
	public function admin_assets( $hook ) {
		...
		if ( 'post.php' === $hook ) {
			wp_enqueue_style( 'editor-stylesheet', get_template_directory_uri() . '/public/css/wp-dashboard/editor.css', [], '1.0.0', 'all' );
		}
	}
	...
	public function admin_color_scheme() {
		wp_admin_css_color(
			...
			get_template_directory_uri() . '/public/css/wp-dashboard/colors.css',
